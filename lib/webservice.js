...
module.exports = function(appName, opt_config) {
    ...
    var error = Joi.validate(config.getConfigSources()[0].parsed, configSchema);
    ...
    {
        config.controller = './controller.js';
    }

    config.logger = utils.getLogger(config, appName);
