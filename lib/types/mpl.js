...
function AssessmentHandler()
{
    ...
    {
        var deferred = Q.defer();
        var exssn = encodeURIComponent(answerKey.answers.exssn);
        ...
        // submission
        //var messageSub = apiSecret + '-' + 'api_key=' + apiKey + 'exssn=' + exssn + 'op=' + op + 'submission=' + encStudentSubmission + 'timestamp=' + timestamp;
        //
        var messageSub = apiSecret + '-' + 'api_key=' + apiKey + 'exssn=' + exssn + 'op=' + op + 'submission=' + studentSubmission.entry + 'timestamp=' + timestamp;
        ...
        var fullUrl = tcUrl + '?op=' + op + '&api_key=' + apiKey + '&timestamp=' + timestamp + '&api_sig=' + apiSig
            + '&exssn=' + exssn + '&submission=' + encStudentSubmission;
