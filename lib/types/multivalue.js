...
function AssessmentHandler()
{
     ...
     * 
     * For multivalue this checks to make sure the submission key is 
    ...
    this.preprocess = function(returnData, answerKey, studentSubmission)
    {
        ...
        // @todo you'll have to iterate over the studentSubmission object
    ...
    this.calculateScoreAndFeedback = function(returnData, answerKey, studentSubmission)
    {
        ...
        //               'feedback': /**@type {htmlString}*/ (questionSolution['incorrectResponse']) };
        ...
        // in the solution.
        var submittedKeys = _.keys(studentSubmission);//goog.object.getKeys(answer);
        var correctValues = questionSolution['correctValues'];
        //var isCorrectAnswer = correctValues.some(
        var isCorrectAnswer = _.some(correctValues,     
                function (correctValueSet)
                {
                    ...
                    // @todo - same as 'some' above
                    return solutionKeys.every(function (key) { return answer[key] === correctValueSet[key]; });
                });
        ...
        else
        {
            ...
            // @todo - we're punting this until the feedback UI story hits.
            /*var correctValueSet = correctValues[0];
            var keyValueFeedback = {};
            submittedKeys.forEach(function (key) { keyValueFeedback[key] = (answer[key] === correctValueSet[key]); });
    ...
    */
     ...
     * the stuff in answerKey.answers.correctValue, or at least the first thing in that
     * array.
     *
    ...
    this.addCorrectAnswer = function(returnData, answerKey, isLastAttempt)
    {
        ...
        if (isLastAttempt && returnData.correctness !== 1) {
            ...
            returnData.correctAnswer = answerKey.answers.correctValue[0];
