...
function AssessmentHandler()
{
     ...
     */
    this.preprocess = function(answers, submission, returnData)
    {
        var deferred = Q.defer();
     ...
     */
    this.calculateScoreAndFeedback = function(answers, submission, returnData)
    {
        var deferred = Q.defer();
     ...
     */
    this.addCorrectAnswer = function(answers, isLastAttempt, returnData)
    {
        var deferred = Q.defer();
