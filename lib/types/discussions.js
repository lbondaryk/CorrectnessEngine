...
function AssessmentHandler()
{
    ...
    this.calculateScoreAndFeedback = function(returnData, answerKey, studentSubmission)
    {
        ...
        // These goes into the brixState object, as they're assessment-specific
        // properties that the IPS doesn't need to know about but does need
        // to hand back to the client and save in NodeResults.
        returnData.brixState = {};
        returnData.brixState.authorId = answerKey.answers.authorId;
        returnData.brixState.topicId = answerKey.answers.topicId;
    ...
    */
    this.calculateStats = function(returnData, studentSubmission)
    {
        ...
        // 2.0 code
        returnData.stats.response = studentSubmission.entry;
        /** }} TinCan 1.0 */
         ...
         */
        returnData.stats.typeCode = 'Simple_Writing_Question_User_Answered';
        ...
        returnData.stats.extensions = {
            ...
            Item_Response_Text: studentSubmission.entry,

            // The following property is assigned by DiscussionsFlowStrategy.
            // YSA: Having another another place to set a data has negative
            // impact on maintainability!
            // An alternative is to have the DiscussionFlowStrategy to call
            // Discussions.post first and pass the argument to CE.
            // "Item_Response_Stored_At_URL":  
            
            // The following can be derived from Assessment_Item_Response_Code
